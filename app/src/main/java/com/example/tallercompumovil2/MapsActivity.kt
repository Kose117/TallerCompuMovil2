    ...
    class MapsActivity : AppCompatActivity(), OnMapReadyCallback, SensorEventListener {
        ...
        fun writeJSONObject() {
            lastLocation?.let { location ->
                ...
                try {
                    // Convierte la ubicación actual en un JSONArray
                    ...
                    // Imprime el contenido del JSON que se guardó
                    Log.i("LOCATION", "Saved JSON content: ${jsonArray.toString()}")
                } catch (e: Exception) {
                    Log.e("LOCATION", "Error writing to JSON file: ${e.message}")
                }
            } ?: run {
        ...
        override fun onMapReady(googleMap: GoogleMap) {
            ...
            map.setOnMapLongClickListener { latLng ->
                ...
                if (locations.size >= 1) {
                    requestRouteFromCurrentLocation(map, locations, Color.RED)
                }
                ...
                override fun onLocationResult(result: LocationResult) {
                    ...
                    result.locations.forEach { location ->
                        ...
                        if (lastWrittenLocation == null || lastWrittenLocation!!.distanceTo(location) > 30) {
                            ...
                            Log.i("movimiento naranja","SE MOVIOOOOOOOOOOOOOOOO?")
                        }
